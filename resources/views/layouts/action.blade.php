...
<a href="javascript:void(0)" data-toggle="tooltip" onClick="editFunc({{ $id }})" title="View Ticket" data-original-title="Edit" class="edit btn btn-secondary bi bi-pencil-square edit">
</a>
<!-- <a href="javascript:void(0)" data-toggle="tooltip" onClick="noteFunc({{ $id }})" title="Leave a note" data-original-title="Delete" class="edit btn btn-primary bi bi-journal-medical edit">
</a> -->
